...
public class ArvoreBinaria {
   ...
   public int getAltura(No i){
	int altura = 0;
      if(i != null){
		  ...
		  altura = ((alturaEsq > alturaDir) ? alturaEsq : alturaDir)+1;
      } 
      return altura;
   }
   ...
   public boolean isBalanceada(No i){
      boolean resp = true;
      if(i != null){
         int alturaEsq = getAltura(i.esq);
         int alturaDir = getAltura(i.dir);
         int diferenca = Math.abs(alturaEsq - alturaDir);
         
         resp = (diferenca <= 1) && isBalanceada(i.esq) && isBalanceada(i.dir);
      }
      return resp;
   }

   public void lab09(No raiz, int nivel){
